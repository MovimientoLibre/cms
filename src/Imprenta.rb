...
class Imprenta
        ...
        @publicaciones_directorios.each do |directorio|
            ...
            archivos.sort.each do |ruta|
                ...
                IO.foreach(ruta) do |linea|
                    ...
                    elsif linea.chomp =~ /^Imagen previa: / && pub.imagen_previa.nil?
                        pub.imagen_previa = $'.strip
    ...
    def paginas_iniciales
        ...
        @plantilla.para_compartir = false
