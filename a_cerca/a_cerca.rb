...
El CMS de Movimiento Libre es un sencillo sistema de gestión de contenidos (Content Management System en inglés, abreviado "CMS":http://es.wikipedia.org/wiki/Cms). Es un programa que permite crear una estructura de soporte para la creación y administración de contenidos de un sitio web.
...
h4. ¿Por qué hacer un CMS que genere páginas estáticas?
...
h4. ¿Qué es lo que hace este CMS?
...
h4. ¿Qué hace el script cuando se ejecuta?
